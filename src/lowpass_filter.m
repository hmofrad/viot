...
% Filter the signal
fc = 500; % Make higher to hear higher frequencies.
...
y = filter(b, a, dataIn);
%sound(y, Fs)
audiowrite('out1.wav', 2*(y1)-y, fs1);
